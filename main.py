...
class PLPredNet(pl.LightningModule):
    ...
    def train_dataloader(self):
        ''' Training dataloader '''
        dataloader = handover_dl(mode='train',
    ...
    def val_dataloader(self):
        ...
        dataloader = handover_dl(mode='valid',
                                 data_dir=FLAGS.data_dir,
                                 batch_size=FLAGS.batch_size,
                                 num_frames=FLAGS.num_frames,
                                 num_classes=FLAGS.num_classes,
    ...
    def configure_optimizers(self):
        ...
        scheduler = select_scheduler(optimizer,
                                     ...
                                     lr=FLAGS.lr,
                                     n_batches=49,  # self.trainer.num_training_batches,
...
def generate_ckpt_path(log_dir, model_name, model_version):
...
def train_one_net(model_version):
    ...
    ckpt_path = generate_ckpt_path(log_dir, model_name, model_version)
